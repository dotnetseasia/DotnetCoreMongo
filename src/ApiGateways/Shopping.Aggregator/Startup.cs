    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<ICatalogService, CatalogService>(c =>
                c.BaseAddress = new Uri(Configuration["ApiSettings:CompanyAdminUrl"]))
            ...
            services.AddHealthChecks()
                .AddUrlGroup(new Uri($"{Configuration["ApiSettings:CompanyAdminUrl"]}/swagger/index.html"), "CompanyAdmin.API", HealthStatus.Degraded)
